...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            data = pd.read_csv("https://raw.githubusercontent.com/harsh2312200/Gem-Price-Prediction_Data/refs/heads/main/gemstone.csv")
            ...
            logging.info("An Error occurred in Data Ingestion part")
